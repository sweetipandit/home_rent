  ...
  <body id="page-top">
            ...
            <?php 
                foreach ($data as $key => $value) {           
                  echo '<div class="card card-inverse card-info mb-3" style="padding:1%;">          
                         ...
                         echo   '<div class="row">
                            ...
                            <h4 class="text-center">Owner Details</h4>';
                              ...
                              if ($value['image'] !== 'uploads/') {
                                # code...
                                echo '<img src="app/'.$value['image'].'" width="150">';
                              }
					...
					echo '<a class="btn btn-warning float-right" href="app/complainBox.php">Complaint</a><br><br>';  
                }
    ...
    <footer style="background-color: #ccc;">
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            <span class="copyright">Your Website 2020</span>
          </div>
          <div class="col-md-4">
